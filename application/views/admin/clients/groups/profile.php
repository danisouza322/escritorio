            ...
            <div role="tabpanel"
                ...
                <div class="row">
                    ...
                    <div
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="vat"><?= _l('client_vat_number'); ?></label>
                                    <div class="input-group">
                                        <input type="text" name="vat" id="vat" value="<?= isset($client) ? $client->vat : ''; ?>" class="form-control">
                                        <span class="input-group-btn">
                                            <button type="button" class="btn btn-info" id="verify-vat-btn" data-toggle="tooltip" title="<?= _l('verify_vat_number'); ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="website" id="website" value="<?= e($client->website); ?>" class="form-control">
                                        <span class="input-group-btn">
                                            <a href="<?= e(maybe_add_http($client->website)); ?>" class="btn btn-default" target="_blank" tabindex="-1">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <i class="fa-regular fa-circle-question pull-left tw-mt-0.5 tw-mr-1" data-toggle="tooltip" data-title="<?= _l('customer_currency_change_notice'); ?>"></i>
                                <?php
                            ...
                            <div class="col-md-6">
                                <div class="form-group select-placeholder">
                                    ...
                                    <select name="default_language" id="default_language" class="form-control selectpicker" data-none-selected-text="<?= _l('dropdown_non_selected_tex'); ?>">
                                        <option value=""><?= _l('system_default_string'); ?></option>
                                        <?php foreach ($this->app->get_available_languages() as $availableLanguage) { ?>
                                            <option value="<?= e($availableLanguage); ?>" <?php if ((isset($client) && $client->default_language == $availableLanguage) || (!isset($client) && get_option('active_language') == $availableLanguage)) { echo 'selected'; } ?>>
...
<script src="<?= base_url('assets/js/clients/vat_verify.js'); ?>"></script>