...
<div role="tabpanel" class="tab-pane" id="company_info">
    ...
    <div class="form-group">
        <label for="cnpja_api_key">Chave da API CNPJA</label>
        <input type="text" class="form-control" id="cnpja_api_key" name="settings[cnpja_api_key]" value="<?= get_option('cnpja_api_key'); ?>">
        <small class="form-text text-muted">Chave de API para consulta automática de CNPJ. Obtenha sua chave em <a href="https://cnpja.com/" target="_blank">cnpja.com</a></small>
    </div>
